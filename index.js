...
async function fetchDomainList() {  
    try {  
        const response = await fetch('https://www.ezhih.com/yumi1.php');  
        if (!response.ok) {  
        ...
        if (microwap) {
            ...
            function showurl() {
                ...
                main.insertAdjacentHTML('afterBegin',
                    '<p>发布页地址1：<a href="https://m.ezhih.com"><span class="host">m.ezhih.com</span></a></p> ' +
                    '<p>发布页地址2：<a href="https://m.github.io"><span class="host">m.github.io</span></a></p>' +
                ...
                showlink.insertAdjacentHTML('afterBegin', '<p>新的地址</p><SPAN class="link" id="use"></SPAN>' +
                    '<p>如果上面地址打不开，请点击下面的地址</p><a href="https://m.ezhih.com"><span class="btn ping">Ping...</span><span class="host">m.ezhih.com</span></a><br>'+
                    '<br>再次提醒<SPAN style="color:red;">请保存此页面为书签</SPAN><br>' +
                    '<br>请牢记发布页<SPAN style="color:red;">m.github.io和m.ezhih.com</SPAN><br>' +
                    '<a class="btn" href="https://www.ebay.com/usr/m.ezhih.com">ebay</a>或聯絡郵箱<SPAN style="color:red;">m@outlook.com</SPAN>取得新地址' +
...
const gonggaoHtml = `<H1>m.ezhih.com-最新地址</H1>
                <P>最新網路上有很多冒牌的m.ezhih.com網站， 一旦點擊進去就會發現不是我們，而且會跳轉到收費，或者不能正常使用的站點。 m.ezhih.com是完全免費的並且不需要登入會員也不會讓您試看然後沒有後續的網站。正確的地址有m.ezhih.com這個地址,后续会增加更多备用地址。除此之外全部都是冒牌的惡意網站，請您詳細辨認。</P>`;  
